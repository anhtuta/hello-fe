const pauseSvg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="currentColor">' +
        '<path d="M0 0 L32 16 L0 32 z"></path>' +
        '</svg>';
const playSvg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" fill="currentColor">' +
        '<path d="M0 0 H12 V32 H0 z M20 0 H32 V32 H20 z"></path>' +
        '</svg>';
const BTN_SHUFFLE_SVG = '<svg fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" ' +
                ...
                '</g> ' +
            '</svg>';
const BTN_SEQUENCE_SVG = '<svg fill="currentColor" id="Layer_1" style="enable-background:new 0 0 16 16;" version="1.1" viewBox="0 0 16 16" width="16px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">' +
            ...
            '</svg>'
const BTN_REPEAT_ONE_SVG = '<svg fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" ' +
